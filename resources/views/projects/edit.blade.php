                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('projects.update', $project->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" name="description" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" rows="4">{{ old('description', $project->description) }}</textarea>
